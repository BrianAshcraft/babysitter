...
<script>
	...
	export let description =
		'Trusted childcare services by Elmira, providing safe and engaging care for children of all ages in Boston, MA.';
	export let image = '/images/elmira-hero.png'; // Default social sharing image
	export let type = 'website';
	export let route = '';
	export let style = ''; // 'fun' or 'professional'

	// Compute the full URL for canonical and OG tags
	const baseUrl = 'https://babysitter-nine.vercel.app/'; // Replace with actual domain when deployed
...
<svelte:head>
	...
	<meta
		name="keywords"
		content="babysitting, childcare, Boston, nanny, babysitter, children, kids, care, {style ===
		'fun'
